...
from sqlalchemy import MetaData, Table, Column, Boolean, Integer, Numeric, String, Text, Time, DateTime, ForeignKey, UniqueConstraint
...
class Postit(Base):
	...
	def __repr__(self):
		return '<Postit(url = {}, content = {}, user = {})>'.format(self.postit_url, self.postit_content, self.user)